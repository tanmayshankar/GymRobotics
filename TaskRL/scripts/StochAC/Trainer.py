...
class Trainer():
	...
	def initialize_memory(self):
		...
		self.initial_transitions = 10000        
		...
		while self.memory.memory_len<self.initial_transitions:
			...
			while counter<self.max_timesteps and self.memory.memory_len<self.initial_transitions:
	...
	For initialize_memory, just randomly sample actions from the action space, use
